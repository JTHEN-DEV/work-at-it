  ...
  public: {
    Tables: {
      ...
      users_rooms: {
        ...
        Relationships: [
          {
            foreignKeyName: "users_rooms_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "users_rooms_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["user_id"]
    ...
    Enums: {
      friendship_status_enum: "pending" | "accepted" | "rejected"
      presence_status_enum: "online" | "offline" | "busy"
    }
    CompositeTypes: {
      [_ in never]: never
    }
